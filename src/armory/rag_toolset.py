...
class RAGManager:
    def __init__(self, tool_name: str, chroma_client: chromadb.HttpClient, collection_name: str,
        ...
        self.add_url.__func__.__name__ = self._tool_name + "_add_url"
        self.add_file.__func__.__name__ = self._tool_name + "_add_file"
        self.add_text.__func__.__name__ = self._tool_name + "_add_text"
        self.search_documents_tool.__func__.__name__ = self._tool_name + "_query"
        self.list_categories_tool.__func__.__name__ = self._tool_name + "_list_cat"
        self.list_documents_tool.__func__.__name__ = self._tool_name + "_list"
        self.delete_document_tool.__func__.__name__ = self._tool_name + "_delete"
    ...
    @register_tool
    async def add_url(self, url: str, category: str = "Other") -> dict[str, list[str]]:
        """
    ...
    @register_tool
    async def add_file(self, url: str, file_name: str, file_type: str, category: str = "Other") -> dict[str, list[str]]:
        """
    ...
    @register_tool
    def add_text(self, document_name: str, content: str, category: str = "Other") -> dict[str, list[str]]:
        """
    ...
    @register_tool
    def search_documents_tool(self, query: str, n_results: int = 4) -> list[dict[str, Any]]:
        """
    ...
    @register_tool
    def list_documents_tool(self, category: str = None, start_date: str = None, end_date: str = None) -> str:
        """
    ...
    @register_tool
    def delete_document_tool(self, document_name: str = None, category: str = None, start_date: str = None,
    ...
    @register_tool
    def list_categories_tool(self) -> str:
        """
