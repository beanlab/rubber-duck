...
from typing import TypedDict, Protocol, ContextManager, TypeVar, Callable
...
class SetupPrivateThread(SetupThread):
...
class HaveStandardGptConversation(HaveConversation):
