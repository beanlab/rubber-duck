...
3. Confirm that there is not already a `docs/plans/<skill-name>-plan.md` in the working directory.
...
4. Using `docs/plans/<skill-name>-design.md` create a stepwise plan to implement the architecture outlined in the file. Write this plan to a file with a name convention of `<skill-name>-plan.md`.
